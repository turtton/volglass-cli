...
kotlin {
    ...
    sourceSets {
        ...
        val jsMain by getting {
            dependencies {
                implementation(project.dependencies.enforcedPlatform("org.jetbrains.kotlin-wrappers:kotlin-wrappers-bom:1.0.0-pre.860"))
                ...
                implementation("com.squareup.okio:okio:3.16.2")?.version?.also {
                    implementation("com.squareup.okio:okio-nodefilesystem:$it")
                }
                implementation("de.jensklingenberg.ktorfit:ktorfit-lib:2.6.4")
                implementation("io.ktor:ktor-client-core:2.3.13")?.version?.also {
